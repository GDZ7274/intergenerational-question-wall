...
| ID | 路由/页面 | 可访问角色 | 主要任务 |
| --- | --- | --- | --- |
| H01 | `home` 沉浸式入口 | 所有人 | 首次显示 2 秒墙面，再选择提问、回答，或下滑进入浏览 |
...
移动端以滑动为主：首页向下滑进入问答墙；问答墙固定视口一次只显示一张便签，上滑下一张、下滑回看，整张卡片可轻点，底部只提供收藏和分享两个快捷动作；问题池纵向滚动，整张问题卡进入回答。底部导航只保留“墙 / 参与 / 我的”，浏览页不再堆叠“下一张”“再看一张”等重复主按钮。
